 ...
 */
package com.hennamehndi.mehndipatterns.bridalmehndi.designs.Ads_Util;
...
import com.hennamehndi.mehndipatterns.bridalmehndi.designs.MainActivity;
import com.hennamehndi.mehndipatterns.bridalmehndi.designs.R;
import com.hennamehndi.mehndipatterns.bridalmehndi.designs.TutorialActivity;
    ...
    public class AppOpenAdManager {
     ...
     /*   private void setDialog() {
        ...
        private void loadAd(Context context) {
            ...
            AppOpenAd.load(context, getString(R.string.open_app_mediumid), request, new AppOpenAdLoadCallback() {
                /**
...
//                    createTimer(COUNTER_TIME);
        ...
        private void forLowloadAd(Context context) {
            ...
            isLoadingAd = true;
            AdManagerAdRequest request = new AdManagerAdRequest.Builder().build();
            AppOpenAd.load(context, getString(R.string.open_app_lowId), request, new AppOpenAdLoadCallback() {
